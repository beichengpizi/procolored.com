...
// let customerId = "7504079061043" // 8587362107573
//  let customerEmail = "2580518100@qq.com"; //sweetz23@proton.me
// 查询所有奖品 
          ...
          <div class="prize-detail">
            ...
            <div class="prize-detail-box">
              <div class="prize-name">
                ...
                <a href="${prizeType === 3 ? 'https://www.procolored.com/account?view=gift-card' : 'https://www.procolored.com/account?view=coupon'}" target="_blank" class="prize-view ${usageStatus !=='unused' ? ' expired' : ''}">View Now></a>
              </div>
              ...
              <a href="${prizeType === 3 ? 'https://www.procolored.com/account?view=gift-card' : 'https://www.procolored.com/account?view=coupon'}" class="prize-view-mb ${usageStatus !=='unused' ? ' expired' : ''}">View Now></a>
            </div>
          </div>
...
// 查询全部的抽奖记录
function getLotteryRecords(activityId) {
...
// 查询用户抽奖机会
function getLotteryChance(id, email,activityId) {
    ...
    .then(data => {
      ...
      if (data.code === 200) {
        ...
        if (loginedWinningWrapper) {
          ...
          // setTimeout(() => { 
                          // 获取可用次数
              availableChance = result.availableChance || 0;
              // 获取总共次数
              const totalChance = result.totalChance || 0;
              // const isShareFB = result.shareFb ? 1 : 0;
              // console.log('是否已分享过', isShareFB);
              console.log('可用抽奖次数', availableChance);
              console.log('总抽奖次数', totalChance);
              // 设置剩余抽奖次数
              if (chanceSpan) {
...
// 分享到社媒
function postShareToAddLotteryChance(id, email, platform) {
  // 构造请求体
  const postData = {
    customerId: id,
    customerEmail: email,
  ...
  fetch(`${api}${doLotteryApi}`, {
    ...
    .then(data => {
      ...
      if (data.code === 200) {
        ...
        const  wheelIndex = result.wheelIndex
        console.log('中奖下标',wheelIndex)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (customerId !== '') {
    ...
    document.querySelectorAll('.my-prize-content-item-not-logged-in').forEach(function (el) {
      el.style.display = 'flex';
    });
  }
});
...
document.querySelectorAll('.logined-winning-box-content-share-item').forEach(function (el) {
  el.onclick = function () {
    ...
    if (el.classList.contains('fb')) {
      ...
      postShareToAddLotteryChance(customerId, customerEmail, platform)
    } else {
      // 不包含 fb
      console.log('不包含 fb');
    }
  ...
  blocks: [
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/20250822-170357.png?v=1755853492",
          width: "100%",
        },
      ],
    },
  ...
  prizes: [
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-5-pc.png?v=1755859288",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-2-pc.png?v=1755859288",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-pc.png?v=1755859288",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-4-pc.png?v=1755859288",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-3-pc.png?v=1755859288",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-1-pc.png?v=1755859288",
          width: "32%",
          top: "20",
        },
      ],
  ...
  blocks: [
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group_51647222-6a19-40c3-b42c-fd1f0ad14ccc.png?v=1755851483",
          width: "100%",
        },
      ],
    },
  ...
  prizes: [
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-5-mb.png?v=1755859323",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-2-mb.png?v=1755859323",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/3b0da42e38c646f4aa08b2d2756c3b1c-mb.png?v=1755927283",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-4-mb.png?v=1755859323",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-3-mb.png?v=1755859323",
          width: "32%",
          top: "20",
        },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Mask_group-1-mb.png?v=1755859323",
          width: "32%",
          top: "20",
        },
      ],
