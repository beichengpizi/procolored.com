              ...
              <div class="prize-detail">
                ...
                <div class="prize-detail-box">
                  <div class="prize-name">
                    <span class="prize-name-value ${
                      usageStatus !== "unused" ? " expired" : ""
                    }">${discountTitle}${
                usageStatus !== "unused" ? " (Expired)" : ""
              }</span>
                    <a href="https://www.procolored.com/account?view=coupon" target="_blank" class="prize-view ${
                      usageStatus !== "unused" ? " expired" : ""
                    }">View Now></a>
                  </div>
                  ...
                  ${
                    prizeUsageScope !== ""
                      ? `<div class="prize-usage-scope">${prizeUsageScope}</div>`
                      : ""
                  } 
                  ${
                    expireAt !== ""
                  ...
                  <a href="https://www.procolored.com/account?view=coupon" class="prize-view-mb ${
                    usageStatus !== "unused" ? " expired" : ""
                  }">View Now></a>
                </div>
              </div>
