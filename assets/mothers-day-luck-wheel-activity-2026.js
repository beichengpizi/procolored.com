...
function formatPrizeTitle(prizeTitle) {
  if(prizeTitle == 'Dual-Station Heat Press') return 'Dual-Station\nHeat Press';
  else if(prizeTitle == 'Single-Station  Heat Press') return 'Single-Station\nHeat Press';
      ...
      if (data.code === 200) {
        ...
        if (Array.isArray(result)) {
          ...
          prizesList = result.map((item, idx) => {
            ...
            const fontTop = isMobile ? 15 : 20;
            const imgTop = isMobile ? 20 : 30;
            const baseObj = {
              background: backgrounds[idx % backgrounds.length],
              fonts: [{
                text: formatPrizeTitle(item.prizeTitle)
                || "",
                top: fontTop,
                fontWeight: 700,
                fontColor: "#420C0E",
    ...
    blocks: [
      {
        ...
        imgs: [
          {
            src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/Group_55058_aac63d6a-504b-4df2-b002-e21b13febbb8.png?v=1777279671",
            width: "100%",
          },
        ],
      },
    ...
    buttons: [
      {
        ...
        imgs: [
          {
            src: "https://cdn.shopify.com/s/files/1/0509/3454/6613/files/1_b2643b12-e2a8-4e06-b2a4-618cdb595b0f.png?v=1777279745",
            width: "100%",
            top: "-85px",
          },
        ],
